...
.question[
Сколько строк и столбцов содержится в этом набоер данных?
]

.pull-left[
```{r}
nrow(starwars) # number of rows # число строк
ncol(starwars) # number of columns # число столбцов
dim(starwars)  # dimensions (row column) # размерность (строки столбцы)
```
]
...
- Разведочный анализ данных заключается в в представлении основных характеристик данных
